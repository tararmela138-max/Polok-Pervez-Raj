...
if uploaded_file is not None:
    if st.button("নতুন ভিডিও তৈরি করুন"):
        with st.spinner("প্রক্রিয়াটি ব্যাকগ্রাউন্ডে চলছে... অনুগ্রহ করে অপেক্ষা করুন..."):
            ...
            # ৫. আকর্ষণীয় ফুটেজ ও কপিরাইট চেক
            video_duration = AudioFileClip("final_audio.mp3").duration
            bg_image_url = "https://images.unsplash.com/photo-1504711434969-e33886168f5c?q=80&w=1280&h=720&fit=crop"
            
            img_data = requests.get(bg_image_url).content
            with open("downloaded_asset.jpg", "wb") as handler:
            ...
            image_clip = ImageClip("downloaded_asset.jpg").set_duration(video_duration)
